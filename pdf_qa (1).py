...
import os
os.environ['HUGGINGFACE_TOKEN'] = "hf_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
...
# tokenizer = AutoTokenizer.from_pretrained(checkpoint, token='hf_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx')
# base_model = AutoModelForCausalLM.from_pretrained(checkpoint, token='hf_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx')
# 
# @st.cache_resource
# def llm_pipeline():
#     pipe = pipeline(
